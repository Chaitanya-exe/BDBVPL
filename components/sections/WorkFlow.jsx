  ...
  return (
    <div className="">
      ...
      <div className="mt-9 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-12">
        <motion.div whileInView={{x:0}} viewport={{once:true}} initial={{x:"-120%"}} transition={{duration:0.8,type:"spring",delay:0.8,damping:30}} className="flex flex-col justify-center lg:gap-28 gap-10  ">
        ...
        <motion.div whileInView={{x:0}} viewport={{once:true}} initial={{x:"120%"}} transition={{duration:0.8,type:"spring",delay:0.8,damping:30}} className="flex flex-col lg:gap-28 justify-center gap-10">
