...
const Conatiner = ({ title, h1, h2, textAllign }) => {
  return (
    <div className={`flex flex-col lg:gap-2 gap-1 capitalize ${textAllign} `}>
      ...
      <h1 className="h1Text md:h1TextLg motion-preset-slide-right text-gray-700">{h1}</h1>
      <h2 className="h2Text md:h2TextLg text-opacity-80 motion-preset-shrink text-gray-700 ">{h2}</h2>
    </div>
  );
};
